...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"NrdrLatStiction", {PERSISTENT, BOOL, "1", "1", 2}},              // emulated EPS breakaway hold/move output stage (NRDR_LATERAL_STICTION.md); for NRDR's modified-EPS Hondas
    ...
    {"HondaCenterScale", {PERSISTENT, FLOAT, "1.0", "1.0", 2}},
    ...
    {"HondaOverrideFadeUpSecs", {PERSISTENT, FLOAT, "1.0", "1.0", 2}},
