...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"NrdrLatAngleRateLimit", {PERSISTENT, INT, "300", "300", 2}},     // deg/s ceiling on desired wheel-angle slew; 0 disables. Backstops clip_curvature, whose ISO jerk limit is ~1/v^2 in angle space and so does not bind below ~20 mph              // emulated EPS breakaway hold/move output stage (NRDR_LATERAL_STICTION.md); for NRDR's modified-EPS Hondas
